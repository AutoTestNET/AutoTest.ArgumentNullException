::"%~dp0..\packages\OpenCover.4.5.1604\OpenCover.Console.exe"
::-register:user
...
::"%~dp0..\packages\ReportGenerator.1.9.0.0\ReportGenerator.exe"
::"C:\git\AutoTest.ArgumentNullException\src\Tests\CoverageResults.xml"
::"C:\git\AutoTest.ArgumentNullException\src\Tests\Report"
::Html

"%~dp0..\packages\ReportGenerator.1.9.0.0\ReportGenerator.exe" "C:\git\AutoTest.ArgumentNullException\src\Tests\CoverageResults.xml" "C:\git\AutoTest.ArgumentNullException\src\Tests\Report" Html
